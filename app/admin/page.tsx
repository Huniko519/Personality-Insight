...
export default function AdminPage() {
  ...
  const { signOut, user, loading, isAdmin } = auth
  ...
  // Only redirect if not loading and user is not authenticated or not admin
  if (!loading && (!user || !isAdmin)) {
    // Use client-side redirect instead of useEffect
